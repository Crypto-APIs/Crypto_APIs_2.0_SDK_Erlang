-module(cryptoapis_get_block_details_by_block_height_from_callback_ribsx).

-export([encode/1]).

-export_type([cryptoapis_get_block_details_by_block_height_from_callback_ribsx/0]).

-type cryptoapis_get_block_details_by_block_height_from_callback_ribsx() ::
