-module(cryptoapis_list_transactions_by_block_hash_ribse).

-export([encode/1]).

-export_type([cryptoapis_list_transactions_by_block_hash_ribse/0]).

-type cryptoapis_list_transactions_by_block_hash_ribse() ::
    #{ 'contract' := binary(),
       'gasLimit' := binary(),
