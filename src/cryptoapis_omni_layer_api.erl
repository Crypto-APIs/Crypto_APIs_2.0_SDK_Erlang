...
-spec get_omni_transaction_details_by_transaction_id_(txid)(ctx:ctx(), binary(), binary(), binary()) -> {ok, cryptoapis_get_omni_transaction_details_by_transaction_id_txid_r:cryptoapis_get_omni_transaction_details_by_transaction_id_txid_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
get_omni_transaction_details_by_transaction_id_(txid)(Ctx, Network, Blockchain, TransactionId) ->
    get_omni_transaction_details_by_transaction_id_(txid)(Ctx, Network, Blockchain, TransactionId, #{}).

-spec get_omni_transaction_details_by_transaction_id_(txid)(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_get_omni_transaction_details_by_transaction_id_txid_r:cryptoapis_get_omni_transaction_details_by_transaction_id_txid_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec get_unconfirmed_omni_transaction_by_transaction_id_(txid)(ctx:ctx(), binary(), binary(), binary()) -> {ok, cryptoapis_get_unconfirmed_omni_transaction_by_transaction_id_txid_r:cryptoapis_get_unconfirmed_omni_transaction_by_transaction_id_txid_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
get_unconfirmed_omni_transaction_by_transaction_id_(txid)(Ctx, Network, Blockchain, TransactionId) ->
    get_unconfirmed_omni_transaction_by_transaction_id_(txid)(Ctx, Network, Blockchain, TransactionId, #{}).

-spec get_unconfirmed_omni_transaction_by_transaction_id_(txid)(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_get_unconfirmed_omni_transaction_by_transaction_id_txid_r:cryptoapis_get_unconfirmed_omni_transaction_by_transaction_id_txid_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec list_omni_tokens_by_address(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_list_omni_tokens_by_address_r:cryptoapis_list_omni_tokens_by_address_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec list_omni_transactions_by_address(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_list_omni_transactions_by_address_r:cryptoapis_list_omni_transactions_by_address_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec list_omni_transactions_by_block_hash(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_list_omni_transactions_by_block_hash_r:cryptoapis_list_omni_transactions_by_block_hash_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec list_omni_transactions_by_block_height(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_list_omni_transactions_by_block_height_r:cryptoapis_list_omni_transactions_by_block_height_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec list_unconfirmed_omni_transactions_by_address(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_list_unconfirmed_omni_transactions_by_address_r:cryptoapis_list_unconfirmed_omni_transactions_by_address_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec list_unconfirmed_omni_transactions_by_property_id(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_list_unconfirmed_omni_transactions_by_property_idr:cryptoapis_list_unconfirmed_omni_transactions_by_property_idr(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
