-module(cryptoapis_list_transactions_by_address_ribsb_vin).

-export([encode/1]).

-export_type([cryptoapis_list_transactions_by_address_ribsb_vin/0]).

-type cryptoapis_list_transactions_by_address_ribsb_vin() ::
    #{ 'addresses' := list(),
       'coinbase' => binary(),
