-module(cryptoapis_list_confirmed_transactions_by_address_ribsz).

-export([encode/1]).

-export_type([cryptoapis_list_confirmed_transactions_by_address_ribsz/0]).

-type cryptoapis_list_confirmed_transactions_by_address_ribsz() ::
    #{ 'bindingSig' := binary(),
