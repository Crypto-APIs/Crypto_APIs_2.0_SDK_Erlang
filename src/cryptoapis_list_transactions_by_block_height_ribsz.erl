-module(cryptoapis_list_transactions_by_block_height_ribsz).

-export([encode/1]).

-export_type([cryptoapis_list_transactions_by_block_height_ribsz/0]).

-type cryptoapis_list_transactions_by_block_height_ribsz() ::
    #{ 'bindingSig' := binary(),
