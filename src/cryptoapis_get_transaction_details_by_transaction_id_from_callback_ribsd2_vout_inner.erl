-module(cryptoapis_get_transaction_details_by_transaction_id_from_callback_ribsd2_vout_inner).

-export([encode/1]).

-export_type([cryptoapis_get_transaction_details_by_transaction_id_from_callback_ribsd2_vout_inner/0]).
