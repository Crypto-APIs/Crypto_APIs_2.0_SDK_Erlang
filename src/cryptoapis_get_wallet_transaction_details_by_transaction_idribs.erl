-module(cryptoapis_get_wallet_transaction_details_by_transaction_idribs).

-export([encode/1]).

-export_type([cryptoapis_get_wallet_transaction_details_by_transaction_idribs/0]).

-type cryptoapis_get_wallet_transaction_details_by_transaction_idribs() ::
    #{ 'locktime' := integer(),
       'size' := integer(),
       'vSize' := integer(),
       'version' := integer(),
