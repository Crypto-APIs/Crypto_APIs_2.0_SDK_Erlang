-module(cryptoapis_decode_raw_transaction_hex_rise2).

-export([encode/1]).

-export_type([cryptoapis_decode_raw_transaction_hex_rise2/0]).

-type cryptoapis_decode_raw_transaction_hex_rise2() ::
