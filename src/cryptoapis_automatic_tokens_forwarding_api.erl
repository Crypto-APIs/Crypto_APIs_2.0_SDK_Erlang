...
-spec add_tokens_to_existing_from_address(ctx:ctx(), binary(), binary()) -> {ok, cryptoapis_add_tokens_to_existing_from_address_r:cryptoapis_add_tokens_to_existing_from_address_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
add_tokens_to_existing_from_address(Ctx, Blockchain, Network) ->
    add_tokens_to_existing_from_address(Ctx, Blockchain, Network, #{}).

-spec add_tokens_to_existing_from_address(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, cryptoapis_add_tokens_to_existing_from_address_r:cryptoapis_add_tokens_to_existing_from_address_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
add_tokens_to_existing_from_address(Ctx, Blockchain, Network, Optional) ->
    ...
    Headers = [],
    Body1 = CryptoapisAddTokensToExistingFromAddressRb,
...
-spec create_automatic_tokens_forwarding(ctx:ctx(), binary(), binary()) -> {ok, cryptoapis_create_automatic_tokens_forwarding_r:cryptoapis_create_automatic_tokens_forwarding_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
create_automatic_tokens_forwarding(Ctx, Blockchain, Network) ->
    create_automatic_tokens_forwarding(Ctx, Blockchain, Network, #{}).

-spec create_automatic_tokens_forwarding(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, cryptoapis_create_automatic_tokens_forwarding_r:cryptoapis_create_automatic_tokens_forwarding_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
create_automatic_tokens_forwarding(Ctx, Blockchain, Network, Optional) ->
    ...
    QS = lists:flatten([])++cryptoapis_utils:optional_params(['context'], _OptionalParams),
    Headers = [],
    Body1 = CryptoapisCreateAutomaticTokensForwardingRb,
    ContentTypeHeader = cryptoapis_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec delete_automatic_tokens_forwarding(ctx:ctx(), binary(), binary(), binary()) -> {ok, cryptoapis_delete_automatic_tokens_forwarding_r:cryptoapis_delete_automatic_tokens_forwarding_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
delete_automatic_tokens_forwarding(Ctx, Blockchain, Network, ReferenceId) ->
    delete_automatic_tokens_forwarding(Ctx, Blockchain, Network, ReferenceId, #{}).

-spec delete_automatic_tokens_forwarding(ctx:ctx(), binary(), binary(), binary(), maps:map()) -> {ok, cryptoapis_delete_automatic_tokens_forwarding_r:cryptoapis_delete_automatic_tokens_forwarding_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec get_fee_address_details(ctx:ctx(), binary(), binary()) -> {ok, cryptoapis_get_fee_address_details_r:cryptoapis_get_fee_address_details_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
get_fee_address_details(Ctx, Blockchain, Network) ->
    get_fee_address_details(Ctx, Blockchain, Network, #{}).

-spec get_fee_address_details(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, cryptoapis_get_fee_address_details_r:cryptoapis_get_fee_address_details_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
...
-spec list_tokens_forwarding_automations(ctx:ctx(), binary(), binary()) -> {ok, cryptoapis_list_tokens_forwarding_automations_r:cryptoapis_list_tokens_forwarding_automations_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
list_tokens_forwarding_automations(Ctx, Blockchain, Network) ->
    list_tokens_forwarding_automations(Ctx, Blockchain, Network, #{}).

-spec list_tokens_forwarding_automations(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, cryptoapis_list_tokens_forwarding_automations_r:cryptoapis_list_tokens_forwarding_automations_r(), cryptoapis_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), cryptoapis_utils:response_info()}.
