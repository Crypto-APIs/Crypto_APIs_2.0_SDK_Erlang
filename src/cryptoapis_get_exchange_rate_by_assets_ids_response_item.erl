-module(cryptoapis_get_exchange_rate_by_assets_ids_response_item).

-export([encode/1]).

-export_type([cryptoapis_get_exchange_rate_by_assets_ids_response_item/0]).

-type cryptoapis_get_exchange_rate_by_assets_ids_response_item() ::
