-module(cryptoapis_get_transaction_details_by_transaction_id_from_callback_ribsz).

-export([encode/1]).

-export_type([cryptoapis_get_transaction_details_by_transaction_id_from_callback_ribsz/0]).

-type cryptoapis_get_transaction_details_by_transaction_id_from_callback_ribsz() ::
    #{ 'bindingSig' := binary(),
