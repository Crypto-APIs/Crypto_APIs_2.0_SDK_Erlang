-module(cryptoapis_transaction_request_approve_data_item).

-export([encode/1]).

-export_type([cryptoapis_transaction_request_approve_data_item/0]).

-type cryptoapis_transaction_request_approve_data_item() ::
    #{ 'blockchain' := binary(),
       'network' := binary(),
