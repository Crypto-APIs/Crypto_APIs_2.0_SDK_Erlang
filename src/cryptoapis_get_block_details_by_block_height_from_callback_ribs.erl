-module(cryptoapis_get_block_details_by_block_height_from_callback_ribs).

-export([encode/1]).

-export_type([cryptoapis_get_block_details_by_block_height_from_callback_ribs/0]).

-type cryptoapis_get_block_details_by_block_height_from_callback_ribs() ::
    #{ 'bits' := binary(),
       'chainwork' := binary(),
       'difficulty' := binary(),
       'merkleRoot' := binary(),
