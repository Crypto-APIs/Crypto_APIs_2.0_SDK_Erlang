-module(cryptoapis_get_asset_details_by_asset_idrisc).

-export([encode/1]).

-export_type([cryptoapis_get_asset_details_by_asset_idrisc/0]).

-type cryptoapis_get_asset_details_by_asset_idrisc() ::
