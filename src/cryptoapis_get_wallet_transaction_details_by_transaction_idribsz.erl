-module(cryptoapis_get_wallet_transaction_details_by_transaction_idribsz).

-export([encode/1]).

-export_type([cryptoapis_get_wallet_transaction_details_by_transaction_idribsz/0]).

-type cryptoapis_get_wallet_transaction_details_by_transaction_idribsz() ::
    #{ 'bindingSig' := binary(),
