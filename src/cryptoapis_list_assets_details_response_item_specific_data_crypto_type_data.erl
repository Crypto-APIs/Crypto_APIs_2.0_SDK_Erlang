-module(cryptoapis_list_assets_details_response_item_specific_data_crypto_type_data).

-export([encode/1]).

-export_type([cryptoapis_list_assets_details_response_item_specific_data_crypto_type_data/0]).

-type cryptoapis_list_assets_details_response_item_specific_data_crypto_type_data() ::
