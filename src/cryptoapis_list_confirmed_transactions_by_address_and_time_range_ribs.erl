-module(cryptoapis_list_confirmed_transactions_by_address_and_time_range_ribs).

-export([encode/1]).

-export_type([cryptoapis_list_confirmed_transactions_by_address_and_time_range_ribs/0]).

-type cryptoapis_list_confirmed_transactions_by_address_and_time_range_ribs() ::
    #{ 'locktime' := integer(),
       'size' := integer(),
       'vSize' := integer(),
       'version' := integer(),
