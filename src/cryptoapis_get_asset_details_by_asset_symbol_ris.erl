-module(cryptoapis_get_asset_details_by_asset_symbol_ris).

-export([encode/1]).

-export_type([cryptoapis_get_asset_details_by_asset_symbol_ris/0]).

-type cryptoapis_get_asset_details_by_asset_symbol_ris() ::
