-module(cryptoapis_list_all_unconfirmed_transactions_ribs).

-export([encode/1]).

-export_type([cryptoapis_list_all_unconfirmed_transactions_ribs/0]).

-type cryptoapis_list_all_unconfirmed_transactions_ribs() ::
    #{ 'locktime' := integer(),
       'size' := integer(),
       'vSize' := integer(),
       'version' := integer(),
